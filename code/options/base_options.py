...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--isX', action='store_true', help='Explainability contents')   
        # basic parameters
        ...
        # S2 Segmentation
        parser.add_argument('--s2_model',  default='unet', type=str)
        parser.add_argument('--s2_list', nargs='+', default=['PAH', 'HE', 'VHE'])

        # S3 Classification
        parser.add_argument('--s3_isfeature', action='store_true') 
        parser.add_argument("--s3_select_feat", nargs='+', default=[0,1,2,3,4,5], help='Select segmentation features for classification (PA count, PA size, PA distance, VHE count, VHE area, VHE distance )')
