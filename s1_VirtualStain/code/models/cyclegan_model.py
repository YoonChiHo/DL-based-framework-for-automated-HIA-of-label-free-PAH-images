...
class CycleGANModel(BaseModel):
    ...
    def __init__(self, opt):
        ...
        visual_names_A = ['real_A', 'fake_B', 'rec_A','real_A_sig','fake_B_sig','real_B_sig']
    ...
    def forward(self):
        ...
        fake_A_normal = (fake_A_mean - (threshold_A/127.5-1))*100
        ...
        self.fake_A_sig = 1 - torch.sigmoid(fake_A_normal)
    ...
    def backward_G(self):
        ...
        # Saliency loss
        self.loss_content = self.criterionContent(self.real_A_sig, self.fake_B_sig) + self.criterionContent(self.fake_A_sig, self.real_B_sig)
        # combined loss and calculate gradients
